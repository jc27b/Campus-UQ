...
public class AdaptadorDePagerFragment extends FragmentPagerAdapter {
     ...
     */
    public AdaptadorDePagerFragment(FragmentManager fm, Context context) {
        super(fm);
        listaDeTiulos = new ArrayList<>();
        listaDeTiulos.add(context.getResources().getString(R.string.noticias));
        listaDeTiulos.add(context.getResources().getString(R.string.directorio));
